<h2><a href="https://leetcode.com/problems/traffic-signal-color/description/">3894. Traffic Signal Color</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>timer</code> representing the remaining time (in seconds) on a traffic signal.</p>
